...
VCS =  vcs -sverilog +vc -Mupdate -line -full64 +define+CLOCK_PERIOD=$(CLOCK_PERIOD)
LIB = /afs/umich.edu/class/eecs470/lib/verilog/lec25dscc25.v

SYNTH_DIR = ./synth

PROGRAM = test_progs/mult_noLSQ_nobranch.s
...
export CLOCK_PERIOD = 8.2	# TODO: You will want to make this more aggresive
